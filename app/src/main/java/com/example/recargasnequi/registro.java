...
public class registro extends AppCompatActivity {
    ...
    public void registrar(View view) {
        ...
        if (!contraseñaUno.isEmpty() && !contraseñaDos.isEmpty() && !nombres.isEmpty() && !phone.isEmpty() && !email.isEmpty()){
            ...
            if (!contraseñaUno.equals(contraseñaDos) || telefono.length()!=10 || !Patterns.EMAIL_ADDRESS.matcher(email).matches()
                    || contraseñaUno.length()!=4 || contraseñaDos.length()!=4){
            ...
            Toast.makeText(this, "Registre correctamente todos los campos", Toast.LENGTH_SHORT).show();
        }
    }
}